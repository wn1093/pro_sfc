...
urlpatterns = [
    ...
    path('hod_check/',HodViews.hod_check,name="hod_check"),
    


    # URLS for Staff
    path('staff_home/', StaffViews.staff_home, name="staff_home"),
    path('staff_check/',StaffViews.staff_check,name="staff_check"),
    ...
    path('staff_add_subject/', StaffViews.staff_add_subject, name="staff_add_subject"),
    path('staff_add_subject_save/', StaffViews.staff_add_subject_save, name="staff_add_subject_save"),
    path('add_subjecttostudent/', StaffViews.add_subjecttostudent, name="add_subjecttostudent"),
    path('get_student1/', StaffViews.get_student1, name="get_student1"),
    path('save_subjecttostudent_data/', StaffViews.save_studenttostudent_data, name="save_subjecttostudent_data"),

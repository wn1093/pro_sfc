...
from student_management_app.models import CustomUser, Staffs, Courses, Subjects, Students, SessionYearModel, Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult,LectureRoom,Subjecttostudent
...
def get_attendance_student(request):
    ...
    for student in attendance_data:
        data_small={"id":student.student_id.admin.id, "name":student.student_id.admin.first_name+" "+student.student_id.admin.last_name, "status":student.status, "attendanceDate":str(attendance.attendance_date)}
        list_data.append(data_small)
...
def staff_add_subject_save(request):
    if request.method != "POST":
        ...
        try:
            ...
            subject = Subjects(subject_name=subject_name,subject_num=subject_num, course_id=course, staff_id=staff, subjects_day = subjects_day, subjects_start_time= subjects_start_time, subjects_stop_time = subjects_stop_time,lectureroom_id=lectureroom)

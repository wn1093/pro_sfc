...
class LectureRoom(models.Model):
    id = models.AutoField(primary_key=True)
    lectureroom_name = models.CharField(max_length =255)
    objects = models.Manager()
...
class Subjects(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    subjects_day = models.CharField(max_length=255, default = '')
    subjects_start_time = models.TextField(max_length=255,default = '')
    subjects_stop_time = models.TextField(max_length=255,default = '')
    lectureroom_id = models.ForeignKey(LectureRoom,on_delete=models.CASCADE, default =1) 
    subject_num = models.CharField(max_length=255)
    objects = models.Manager()
...
#학생 출석 추가
class subject_atten(models.Model):
    id = models.AutoField(primary_key=True)
    student_id = models.ForeignKey(Students, on_delete = models.CASCADE)
    Subject_id = models.ForeignKey(Subjects, on_delete = models.CASCADE)
    sub_attendance = models.IntegerField(default = 0)
    attendance_day = models.DateField()

class Subjecttostudent(models.Model):
    id = models.AutoField(primary_key =True)

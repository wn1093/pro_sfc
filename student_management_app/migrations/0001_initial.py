# Generated by Django 3.2 on 2022-11-03 08:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('subjects_day', models.CharField(default='', max_length=255)),
                ('subjects_start_time', models.TextField(default='', max_length=255)),
                ('subjects_stop_time', models.TextField(default='', max_length=255)),
                ...
                ('lectureroom_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='student_management_app.lectureroom')),
                ('staff_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Subjecttostudent',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
